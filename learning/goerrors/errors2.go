...
// go run learning/goerrors/errors2.go 10 2
// get:
// 10 / 2 == 5, 10 % 2 == 0
//
// go run learning/goerrors/errors2.go asdf 2
// output:
// Invalid argument #1
// error: strconv.ParseInt: parsing "asdf": invalid syntax
// exit status 1
//
// go run learning/goerrors/errors2.go 10 asdf
// output:
// Invalid argument #2
// error: strconv.ParseInt: parsing "asdf": invalid syntax
// exit status 1
//
// go run learning/goerrors/errors2.go 10 0
// output:
// There was an error: Values: 10 and 0 produced error Cannot divide by zero
// exit status 1
